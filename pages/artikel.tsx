            ...
            <div className={"px-8 md:px-20 pt-[100px] font-poppins"}>
                ...
                <div className="lg:flex mt-7 md:mt-14 mb-28">
                    <div className="w-full lg:w-2/3 lg:pr-14">
                        ...
                        <h1 className={"text-black font-semibold text-xl lg:text-4xl mb-4"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod </h1>
                        <p className={'text-gray-500 mb-4'}>Alfian Tri Wahyu | Malang, 17 Agustus 1945</p>
