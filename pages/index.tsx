    ...
    <>
      <div className='bg-base/35 text-base pt-[80px] flex lg:h-[745px] -z-20'>
        ...
        <div className='z-0 py-20 px-4 md:px-20 lg:w-3/6 lg:px-28 lg:py-28 text-center lg:text-left object-left font-poppins'>
          <h1 className='text-3xl lg:text-4xl font-semibold mb-4 lg:mb-4'>{t('homepage:title')}</h1>
          <h2 className='text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 lg:mb-8'>{t('homepage:subtitle')}</h2>
          <p className='lg:text-lg mb-8 text-grey lg:text-justify'>{t('homepage:description')}</p>
        </div>
      ...
      <div className={"px-4 lg:flex lg:px-28 my-14"}>
        ...
        <div className={"lg:w-1/2 font-poppins px-8 mt-8 lg:mt-0 flex items-center"}>
      ...
      <div className={"bg-base lg:w-4/5 rounded-tr-[200px] lg:px-28 mt-14 py-8"}>
        <CardContainer
        ...
        <div className={"w-full flex justify-end"}>
          <div className={"bg-ylw/65 lg:w-4/5 right-0 rounded-tl-[200px] lg:px-28 mt-14 py-8"}>
            <CardContainer
                title={t('navbar:tri_dharma')}
                href='/tri-dharma'
            >
