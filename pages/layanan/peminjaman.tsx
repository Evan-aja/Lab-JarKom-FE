...
export default function Peminjaman({ data }: { data: APIResponse }) {
  ...
  const addInput = () => {
    setBarangInputs([...barangInputs, { jumlah: 0 }]);
  };
      ...
      <Content>
        <div className="text-center mb-20">
          <h3 className="text-baseDark font-bold text-3xl mb-8">
            {t("services:borrow.rules_title")}
          </h3>
          <div className="bg-warning p-4 font-semibold rounded-2xl xl:mx-32 mb-4">
            {t("services:borrow.rules_1")}
          </div>
          <div className="bg-warning p-4 font-semibold rounded-2xl xl:mx-32 mb-4">
            {t("services:borrow.rules_2")}
          </div>
          <div className="bg-warning p-4 font-semibold rounded-2xl xl:mx-32">
            {t("services:borrow.rules_3")}
          </div>
        </div>
        <div className="mb-20">
          <h3 className="text-baseDark font-bold text-3xl mb-8">
            {t("services:borrow.data_title")}
          </h3>
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <Input
                value={nim || ""}
                onChange={(e) => setNim(Number.parseInt(e.target.value))}
                className="w-full"
                type="number"
            ...
            >
              ...
              <Input
                ...
                className="w-full"
                type="text"
                placeholder="Kebutuhan Praktikum"
                bordered
                required
              />
            </InputGroup>
            ...
            <div className="text-center">
              <Button
                color="warning"
                type="submit"
                className={`w-full lg:w-52 ${isLoading && "loading"}`}
              >
                {t("button_send")}
              </Button>
            </div>
