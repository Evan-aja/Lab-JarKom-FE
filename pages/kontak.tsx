    ...
    <>
      <div className={"pt-[90px] px-8 md:px-14 lg:px-28 mb-24"}>
          ...
          <div className={"mt-24 lg:flex w-full justify-between font-poppins"}>
              <div className={"lg:w-3/12 my-12 lg:my-0 lg:justify-start flex justify-center items-center "}>
                <div className="">
                  ...
                  <div className={""}>
                    <div className="flex justify-center lg:justify-start">
                        <div className="mr-3">
                            ...
                            svg={
                                <svg xmlns="http://www.w3.org/2000/svg" fill="black" className="h-4 w-4" viewBox="0 0 300 300">
                        ...
                        <div className="">
                            <Socials
                                ...
                                svg={
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="black" className="h-4 w-4" viewBox="0 0 16 16">
              ...
              <div className={"lg:w-4/12 my-12 lg:my-0 flex items-center justify-center"}>
              ...
              <div className={"border-r border-gray-300 hidden lg:block"}></div>
              <div className={"lg:w-5/12 my-12 lg:my-0 lg:justify-end justify-center items-center flex"}>
                  <svg
                  ...
                  <div className={"ml-4"}>
                      <p className={"font-poppins text-[14px]"}>Fakultas Ilmu Komputer Gedung F Lt. 9.6</p>
                      <p className={"font-poppins text-[14px]"}>Jl. Veteran No. 8, Malang, 65145, </p>
