...
const Card: React.FC<CardProps> = ({ id, title, image, content, link }) => {
  return (
    <div className="w-full rounded-[30px] overflow-hidden shadow-lg sm:text-sm md:text-base lg:text-lg xl:text-xl font-poppins">
      <div className="object-cover aspect-[3/2]">
        <img
      ...
      <div className="px-6 my-4">
        ...
        <p
          className="text-gray-700 text-gray text-sm line-clamp-2"
          style={{
            display: "-webkit-box",
            overflow: "hidden",
            WebkitLineClamp: 2,
      ...
      <div className="px-6 mb-4 flex self-right">
        <a href={link} className="bg-ghost text-sm text-base py-2 rounded">
          Read More
        </a>
      </div>
    </div>
