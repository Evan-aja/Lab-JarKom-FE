...
export default function CustomJumbotron({
  ...
  const button = (
    <Button
      className="border-0 bg-white text-black hover:bg-[#ffffffdd] px-20 shadow-lg"
      onClick={scroll}
    >
      {buttonText}
    </Button>
  ...
  return (
    <>
      <div className="bg-base/35 text-white pt-[80px]">
        <div className="py-20 lg:py-28 text-center">
          ...
          <p className="mx-4 md:mx-20 lg:text-lg xl:mx-72 mb-8">
            {description}
          </p>
          {buttonText &&
            (buttonHref ? (
      ...
      <div className="bg-gradient-to-b from-base/35 h-36" id="gradient" />
    </>
  );
}
