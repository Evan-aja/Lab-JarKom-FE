    ...
    <Navbar className={"z-50 p-4 fixed bg-white text-poppins shadow-sm"}>
      <Navbar.Start className="w-2/12">
        <Dropdown>
          ...
          <Dropdown.Menu
            tabIndex={0}
            className="w-52 menu-compact mt-3 text-black"
          >
            <Dropdown.Item
              href="/"
            ...
            <Dropdown.Item
              ...
              className={router.pathname == "/profil" ? "font-semibold" : ""}
            >
              {t("navbar:profile")}
              {isProfileOpen ? (
                <svg
            ...
            <Dropdown.Item
              href="/tri-dharma"
              className={
                router.pathname == "/tri-dharma" ? "font-semibold" : ""
              }
            >
              {t("navbar:tri_dharma")}
            </Dropdown.Item>
            <Dropdown.Item
              ...
              className={
                router.pathname.startsWith("/layanan") ? "font-semibold" : ""
              }
            >
              {t("navbar:services")}
              {isOpen ? (
            ...
            <Dropdown.Item
              href="/kontak"
              className={router.pathname == "/kontak" ? "font-semibold" : ""}
            >
              {t("navbar:contacts")}
            </Dropdown.Item>
          </Dropdown.Menu>
        ...
        >
          <div
            className={`w-8 h-8 mr-3 duration-200`}
            style={{
      ...
      <Navbar.Center className={"font-poppins"}>
        <Menu
          horizontal
          className="p-0 w-full hidden lg:flex lg:justify-between "
        >
          <Menu.Item>
            <Link
              href="/"
              className={
                router.pathname == "/"
                  ...
                  : "" + "hover:text-base hover:bg-transparent font-medium"
              }
            >
              {t("navbar:home")}
            </Link>
          ...
          <div className="dropdown dropdown-hover hover:text-base">
            <label
              ...
              className={`btn btn-ghost normal-case font-poppins font-medium m-1 bg-base/0 outline-0 hover:text-base hover:bg-transparent text-[16px] ${
                router.pathname === "/profil" || router.pathname === "/anggota"
            ...
            >
              <li className="bg-base text-white w-120 hover:text-base hover:bg-white">
                <a href="/profil" className="w-max hover:bg-transparent">
                  {t("navbar:profile")}
                </a>
              </li>
              <li className="bg-base text-white w-120 hover:text-base hover:bg-white">
                <a href="/anggota" className="w-max hover:bg-transparent">
                  {t("navbar:people")}
                </a>
              </li>
            </ul>
            ...
            <Link
              ...
              className={
                router.pathname == "/tri-dharma"
                  ? "font-semibold text-base bg-transparent"
                  : " " +
                    "hover:text-base hover:bg-transparent font-medium focus:bg-transparent focus:text-base"
              }
            >
              {t("navbar:tri_dharma")}
            </Link>
          ...
          <div className="dropdown dropdown-hover hover:text-base">
            <label
              tabIndex={0}
              className={`btn btn-ghost normal-case font-poppins font-medium m-1 bg-base/0 outline-0 hover:text-base hover:bg-transparent text-[16px] ${
                router.pathname === "/layanan/presensi" ||
                router.pathname === "/layanan/peminjaman" ||
                router.pathname === "/layanan/pklskripsi"
                  ? "text-base font-semibold"
                  : ""
              }`}
            >
        ...
        <Link
          ...
          className={
            router.pathname == "/kontak"
              ? "btn btn-primary mr-14 font-semibold font-poppins hidden normal-case lg:flex"
              : "" +
                "btn btn-primary mr-14 font-medium font-poppins hidden lg:flex normal-case"
          }
        >
          {t("navbar:contacts")}
        </Link>
